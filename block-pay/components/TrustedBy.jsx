...
const TrustedBy = () => {
  return (
    <section className="w-full px-4 md:px-6 lg:px-16 xl:px-20 mt-12 text-center">
      <h2 data-aos='fade-up-left' className="trust text-color text-2xl md:text-3xl font-semibold mb-4">
        Trusted By
      </h2>

      <div data-aos="zoom-out-left" className="flex flex-wrap justify-center items-center">
